...
public class WolfModelPower extends Power {
    private boolean isActive = false;
    private final ActionFactory<Entity>.Instance action;
    public WolfEntity wolfEntity;

    public WolfModelPower(PowerType<?> type, LivingEntity entity, ActionFactory<Entity>.Instance action) {
        super(type, entity);
        this.action = action;
        this.setTicking();
        ...
        return new PowerFactory<>(ThiLib.identifier("wolf_form"),
            ...
            data ->
                    (powerType, livingEntity) -> {
                        ...
                        return new WolfModelPower(powerType, livingEntity, action);
                    }).allowCondition();
    }
}
